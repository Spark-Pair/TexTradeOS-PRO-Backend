...
import { getPurchase, getPurchaseItems, highestArticleSequence, lastPurchaseSequence, listPurchases, removePurchase, savePurchaseRecord } from "./purchase.model.js";
...
export const savePurchase = (businessId, userId, payload = {}, id = "") => {
  ...
  const purchaseNumber = existing?.purchase_number || `P-${year}-${String(lastPurchaseSequence(businessId, year) + 1).padStart(4, "0")}`;
